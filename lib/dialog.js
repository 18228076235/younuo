(function($){
	...
	$.fn.dialog = function(options,callBack){
	    ...
	    var defaultDialog = {
	      width:              280,                    	  //宽度
	      height:             0,                     //高度
	      padding:            '1px 0px',                //padding
	      title:              '提示信息',                    //提醒信息
	      titleFontSize: 	  '12px', 					  //title的字体大小
	      discription:        '商品加入购物车成功',          //描述
	      discriptionFontSize:'12px', 					  //描述的字体大小
	      borderRadius:       '2px',                      //圆角
	      buttons:           false,/* [							  //按钮信息 (最多两个)
	      						{						  
	      							name: '确定',
	      							className: 'defalut'
	      						},{
	      ...
	      maskBg:             'rgba(255,255,255,0.6)',          //遮罩层背景色
